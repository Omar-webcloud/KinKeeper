  ...
  return (
    <main className="min-h-screen bg-[#f6f8f8] px-12 pb-24 pt-3.5">
      ...
      <section className="mx-auto mt-16 max-w-5xl">
        <h1 className="text-[34px] font-bold text-[#1f2937]">Friendship Analytics</h1>
        
        <div className="mb-10 mt-8 flex h-[440px] flex-col relative rounded-[16px] border border-[#e2e8f0] bg-white p-8 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
